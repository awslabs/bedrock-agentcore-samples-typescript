...
const sqlQueryTool = {
  ...
  config: {
    ...
    description:
      'Execute SQL queries using Amazon Athena and return the results. Waits for query completion and returns data.',
...
const listActionItemsTool = {
  ...
  config: {
    ...
    description:
      'List all action items with their current status, type, and details. Use this to get an overview of pending, approved, rejected, or deferred actions.',
    inputSchema: z.object({
...
const listWorkoverJobsTool = {
  ...
  config: {
    ...
    description:
      'List all workover rig jobs with their status, priority, financial metrics, and scheduling information. Use this to get an overview of the workover job queue.',
    inputSchema: z.object({
...
const getWorkoverJobTool = {
  ...
  config: {
    ...
    description:
      'Get detailed information about a specific workover job by its ID, including financial metrics and scheduling details.',
    inputSchema: z.object({
